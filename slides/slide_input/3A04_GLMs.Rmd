...
Fit for the second model is better, because payroll isn't really a _predictor_ of loss. It is a scaling element for exposure. Think the number of deaths by heart disease in Manhattan vs. number of deaths by heart disease in a rural town.
